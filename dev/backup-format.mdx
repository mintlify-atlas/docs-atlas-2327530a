---
title: "Backup Archive Format: Layout, Encodings, and Record Types"
sidebarTitle: Backup Format
description: Developer reference for the .ntmb ZIP archive layout, RecordType entries, supported encodings, and the JSON book record schema used in NTMB backups.
---
...
| `Cover` | _(per-file)_ | Individual cover image files. Multiple entries per archive. Named by book UUID and cover index. |
