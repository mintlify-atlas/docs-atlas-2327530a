...
<CardGroup cols={2}>
  ...
  <Card title="Preferences" icon="sliders">
    All app settings, custom identifiers, tag definitions, and Calibre library configurations.
  </Card>
...
<Steps>
  ...
  <Step title="Choose what to include">
    ...
    - **Preferences** — app settings, Calibre credentials, custom tags, and identifiers
    - **Styles** — your personalised list display styles

    Preferences and Styles are included by default when the ZIP format is selected.
  </Step>
